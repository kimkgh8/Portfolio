			...
			<div class="jb-main">
				...
				<div id="popup" class="hide">
					<div class="content">
						...
						다른 문서의 정보를 이용하여 해당 문서의 항목을 갱신하는 프로그램 등 도 있었습니다. <br />그 안에 비동기 처리도
						있었기 때문에 스레드를 이용한 개발도 경험 했습니다. <br />
						<br />이 프로젝트에서는 많은 데이터를 관리 및 작업을 해야했기 때문에 반복문을 많이 사용하여 효율적인 처리를
						할수있는가에 대해 배우면서 성장했던 유익한 프로젝트였습니다.
