...
<body class="welcome-body">
			...
			<div class="jb-main">
				...
				<div id="popup" class="hide">
					<div class="content">
				        ...
				        <br/>위의 배치 프로그램은 데이터 수가 만 단위였기 때문에 SQL튜닝 및 코드 최적화 작업을 실시하였습니다.  <br/>
	...
	<div class="jb-content">
		<div class="jb-container">
			...
			<div class="jb-main">
				<p>
					부동산 회사의 영업 지원 시스템<br /> <br /> <small> 부동산 관련 영업의 지원 시스템으로써 영업에 필요한 자료를 작성, 관리 하는 시스템 <br />
					</small><small>완성된 시스템에 새로운 기능을 추가 및 기존 버그 수정을 주로 하는 프로젝트 <br />
					</small><small>프론트엔드 백엔드 구분 없이 다양한 경험을 했던 프로젝트로 기억에 남아 있습니다.<br />
					</small><small>・100줄 이상의 SQL문들이 존재해서 그 내용을 해석해 버그를 찾아내기도 했습니다. 그 경험이 SQL에 대한 이해도를 높일수 있던 좋은 경험이였다고 생각합니다.<br />
					</small><small>영업 지원 시스템이지만 그 이외에도 여러가지 시스템이 존재해서 상호 작용을 하는 기능들도 있어 팀 단위로 커뮤니케이션을 하면서 팀단위 작업을 많이 했습니다.<br />
						<br />
						<h2>■ 담당 업무</h2>
						<ul>
		...
		<div class="jb-container">
			...
			<div class="jb-main">
				<p>
					신용카드 결제 인증 서비스<br /> <br /> <small> 신용카트의 결제정보 일람, 데이터 분석 후 자료 작성, 전자상 거래에 필요한 결제 기능을 제공하는 서비스 <br />
...
고려했어야 했기 때문에 처리의 성능 확인 및 SQL의 성능을 확인하는 작업도 했던 기억이 있습
니다.<br />
						<br />
						<h2>■ 담당 업무</h2>
						<ul>
