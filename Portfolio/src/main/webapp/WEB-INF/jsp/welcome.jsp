		...
		<div class="jb-container">
			...
			<div class="jb-main">
				<p>
					...
					</small><small>프론트엔드는 일본의 한 업체의 패키지를 이용하고 java의 API와배치프로그램을 개발하였습니다.<br />
						<br />
						<h2>■ 담당 업무</h2>
						<ul>
				...
				<div id="popup" class="hide">
					<div class="content">
						<img class = "jb-dataFlowImg" src="../../resouces/image/dataflow.JPG" /><br />
						 ・문서 사후 처리 프로그램 : 보통은 문서의 데이터를 DB에 출력하는 처리 프로그램 <br />DB에 출력하는 처리 외로
						다른 문서의 정보를 이용하여 해당 문서의 항목을 갱신하는 프로그램 등 도 있었습니다. <br />그 안에 비동기
						처리도 있었기 때문에 스레드를 이용한 개발도 경험 했습니다. <br /> <br />
						・플러그인 : 문서의 등록/삭제/갱신 등의 처리 전의 문서의 내용에 문제가 없는지 체크하는 처리를 포함 하고 있습니다.
						 <br />
						 <br />
						・배치프로그램 : 문서의 여러 가지 정보를 수집(SQL)하여 DB에 출력하는 프로그램(약 6만건 이상) <br />위의
						배치 프로그램은 데이터 수가 만 단위였기 때문에 SQL튜닝 및 코드 최적화 작업을 실시하였습니다. <br /> <br />
						이 프로젝트에서는 많은 데이터를
